@extends('layouts.app', ['page' => __('anggota'), 'title' => __('Anggota')])
          ...
          <div class="card-header card-header-icon card-header-primary">
            <div class="row">
              ...
              <div class="col-6 text-right">
                <a class="btn btn-sm btn-primary btn-round" href="{{ url('anggota/tambah') }}">
                  ...
                  <tr>
                    ...
                    <td class="td-actions text-right">
                      <a class="btn btn-success btn-round" title="Detail"
                        href="{{ url('anggota/detail/'.$dt->kode_anggota) }}">
                        <i class="material-icons">search</i>
                      </a>
                      <a class="btn btn-warning btn-round" title="Edit"
                        href="{{ url('anggota/edit/'.$dt->kode_anggota) }}">
                        <i class="material-icons">edit</i>
                      </a>
                      <a class="btn btn-danger btn-round" title="Hapus" href="javascript:;"
                        onclick="handleDelete('{{ url('anggota/hapus/'.$dt->kode_anggota) }}')">
