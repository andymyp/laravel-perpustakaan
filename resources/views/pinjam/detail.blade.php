@extends('layouts.app', ['page' => __('pinjam'), 'title' => __('Detail Peminjaman')])
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <div class="form-group bmd-form-group">
                  ...
                  <input type="text" class="form-control" value="{{ date('d-m-Y', strtotime($pinjam->harus_kembali)) }}"
                    readonly>
                </div>
                <div class="form-group bmd-form-group">
                  <label>Status Pinjaman</label>
                  <input type="text" class="form-control" value="{{ $pinjam->status == 'P' ? 'Pinjam' : 'Kembali'  }}"
                    readonly>
                </div>
              </div>
            </div>
