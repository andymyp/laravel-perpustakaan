@extends('layouts.app', ['page' => __('insiden'), 'title' => __('Detail Insiden')])
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group bmd-form-group">
                  ...
                  <input type="text" class="form-control" value="{{ $insiden->kode_anggota }}" readonly>
                </div>
                <div class="form-group bmd-form-group">
                  <label>Kode Pinjam</label>
                  <input type="text" class="form-control" value="{{ $insiden->kode_pinjam }}" readonly>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group bmd-form-group">
                  <label>Nama</label>
                  <input type="text" class="form-control" value="{{ $insiden->nama }}" readonly>
                </div>
                <div class="form-group bmd-form-group">
                  <label>Tanggal</label>
                  <input type="text" class="form-control" value="{{ date('d-m-Y', strtotime($insiden->tanggal)) }}"
                    readonly>
                </div>
              </div>
            </div>
